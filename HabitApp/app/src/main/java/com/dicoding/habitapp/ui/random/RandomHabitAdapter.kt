...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val pageTitle: TextView = itemView.findViewById(R.id.pager_tvTitle)
        private val pageStartTime: TextView = itemView.findViewById(R.id.pager_tvstartTime)
        private val pageMinutes: TextView = itemView.findViewById(R.id.pager_tvMinutes)
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            pageStartTime.text = pageData.startTime
            pageMinutes.text = pageData.minutesFocus.toString()
