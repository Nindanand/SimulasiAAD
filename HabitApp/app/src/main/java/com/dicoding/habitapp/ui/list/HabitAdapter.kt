...
class HabitAdapter(
    ...
    inner class HabitViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(habit: Habit) {
            ...
            val priorityDrawableResId = when (habit.priorityLevel.uppercase(Locale.getDefault())) {
                RandomHabitAdapter.PageType.LOW.name -> R.drawable.ic_priority_low
                RandomHabitAdapter.PageType.MEDIUM.name -> R.drawable.ic_priority_medium
                RandomHabitAdapter.PageType.HIGH.name -> R.drawable.ic_priority_high
                else -> R.drawable.ic_priority_medium
            }
            ivPriority.setImageResource(priorityDrawableResId)
        }
    }
